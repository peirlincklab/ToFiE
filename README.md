...
> The preprint describing this method is **currently in preparation**.  
> Please **do not copy, reuse, or redistribute** this code or any associated materials until the preprint is publicly released.  
> For permission or collaboration inquiries, contact: r.togo@tudelft.nl
...
Note: ToFiE uses DisPerSE for one stage of the analysis pipeline. DisPerSE is not redistributed with ToFiE and must be obtained separately by users in accordance with its own licensing and installation requirements.
